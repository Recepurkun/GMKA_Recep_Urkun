...
def draw_landmarks_on_image(rgb_image,detection_result):    
    ...
    handedness_list = detection_result.handedness #tespit edilen elin sağ veya sol el olduğunu gösterecek
    ...
    for idx in range(len(hand_landmarks_list)):
        ...
        handedness = handedness_list[idx] #indeksi kullanarak hangi elin tespit edildiğini bulur
        ...
        solutions.drawing_utils.draw_landmarks( #el işaretlemeleri verilip görüntü üzerine çizilir
            annotated_image,
...
if __name__=='__main__':
    ...
    image = cv2.imread("../data/el_tespiti_1.jpeg")
    ...
    print(detection_result) #buradan dönen sonuc ile elimizi tespit edebilmiş mi anlayabiliriz
    """
    HandLandmarkerResult(handedness=[[Category(index=0, score=0.9754452705383301, display_name='Left', category_name='Left')]]
    ##Ve evet edebildiğini görebiliyoruz. Doğru olarak(Sol el) tespit edebilmiş.
    """
    ...
    cv2.imwrite("../data/el_tespit_odev_sonuc.jpg",image)

    
    """"
    "el_tespit_odev_sonuc.jpg" olarak bilerek kaydettim çünkü aradaki işlemlerin de çalıştığından emin olabilmek için yaptım.
    Toplamda elimizde 3 adet resmimiz oldu;
        1)Ham fotoğraf, 
        2)Üzerinde istenilen(blur,resize) işlemlerin gerçekleştiği hali ve
        3)Elimizin tespit edildiği hali.
    """