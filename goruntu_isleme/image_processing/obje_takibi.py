...
while True:
    ...
    print(results.multi_hand_landmarks) #el tespiti koordinatları
    ...
    if results.multi_hand_landmarks: #her bir landmarks içerisinde gezilir
        for handlms in results.multi_hand_landmarks: #handlms ile x,y ve z koordinatları alınır
            ...
            for number,lm in enumerate(handlms.landmark):
                ...
                if((number==5)|(number==6)|(number==7)|(number==8)): #baş parmak için
                #if((number==9)|(number==10)|(number==11)|(number==12)): #orta parmak için
                #if((number==4)|(number==8)|(number==12)|(number==16)|(number==20)): #sadece parmak uçları için
